...
class DataStorage:
    ...
    def save_fundamentals(self, symbol: str, data_type: str, df: pd.DataFrame) -> str:
        """
    ...
    def load_fundamentals(self, symbol: str, data_type: str) -> pd.DataFrame:
        """
            ...
            for _, row in df.iterrows():
                try:
                    cursor.execute(
                        ...
                        (symbol, filing_date, report_type,
                         accession_number, report_url, filing_url, stored_path)
                        VALUES (?, ?, ?, ?, ?, ?, ?)
                    """,
                        (
                            symbol,
